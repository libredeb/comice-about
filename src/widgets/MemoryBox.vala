public class MemoryBox : Gtk.Box {
    ...
    public MemoryBox() {
        ...
        for (i = 0; i < ram.getSlots(); i++) {
            total += int.parse(ram.getSizes()[i]);
        }
        ...
        ram_modules_box.get_style_context().add_class("ram_bays");
        ...
        lbl_ram_1.set_markup ("<b>" + ram.getSizes()[0] + " GB</b>");
        ...
        if (ram.getSlots() >= 2) {
            ...
            lbl_ram_2.set_markup ("<b>" + ram.getSizes()[1] + " GB</b>");
        ...
        if (ram.getSlots() >= 3) {
            ...
            lbl_ram_3.set_markup ("<b>" + ram.getSizes()[2] + " GB</b>");
        ...
        if (ram.getSlots() == 4) {
            ...
            lbl_ram_4.set_markup ("<b>" + ram.getSizes()[3] + " GB</b>");
